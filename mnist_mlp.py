...
def plot_combined_results(
    ...
    fig.suptitle("MINST MLP Hyperparameter Optimization", fontsize=16)
    ...
    plt.tight_layout()
    plt.savefig("./results/plot/mnist-mlp.png")
...
def main():
    ...
    save_to_csv(
        "./results/csv/mnist-mlp-sa_results.csv",
        sa_lrs,
        sa_train_losses,
        sa_test_losses,
        sa_train_accuracies,
    ...
    save_to_csv(
        "./results/csv/mnist-mlp-static_lr_results.csv",
        [initial_lr] * epochs,
        static_train_losses,
        static_test_losses,
        static_train_accuracies,
