...
def plot_combined_results(
    ...
    fig.suptitle("CIFAR-10 MLP Hyperparameter Optimization", fontsize=16)
    ...
    plt.tight_layout()
    plt.savefig("./results/plot/cifar10-mlp.png")
...
def main():
    ...
    net_sa = SimpleMLP(3072, 100, 10).to(device)
    (
        sa_lrs,
        sa_train_losses,
        sa_test_losses,
    ...
    net_static = SimpleMLP(3072, 100, 10).to(device)
    (
        static_train_losses,
        static_test_losses,
        static_train_accuracies,
    ...
    save_to_csv(
        "./results/csv/cifar10-mlp-sa_results.csv",
        sa_lrs,
        sa_train_losses,
        sa_test_losses,
        sa_train_accuracies,
    ...
    save_to_csv(
        "./results/csv/cifar10-mlp-static_lr_results.csv",
        [initial_lr] * epochs,
        static_train_losses,
        static_test_losses,
        static_train_accuracies,
