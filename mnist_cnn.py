...
def plot_combined_results(
    ...
    fig.suptitle("MINST CNN Hyperparameter Optimization", fontsize=16)
    ...
    plt.tight_layout()
    plt.savefig("./results/plot/mnist-cnn.png")
...
def main():
    ...
    net_static = MINSTModel().to(device)
    (
        static_train_losses,
        static_test_losses,
        static_train_accuracies,
    ...
    save_to_csv(
        "./results/csv/mnist-cnn-sa_results.csv",
        sa_lrs,
        sa_train_losses,
        sa_test_losses,
        sa_train_accuracies,
    ...
    save_to_csv(
        "./results/csv/mnist-cnn-static_lr_results.csv",
        [initial_lr] * epochs,
        static_train_losses,
        static_test_losses,
        static_train_accuracies,
